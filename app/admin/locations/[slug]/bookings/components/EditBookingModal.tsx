      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <select
              value={editing.bayId}
              onChange={(e) =>
                onUpdateField({ bayId: e.target.value })
              }
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                onUpdateField({ startHHMM: e.target.value })
              }
              className="w-full rounded-lg border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-black"
            >
              {timeOptions.map((o) => (
        ...
        <div className="flex justify-between items-center pt-4 border-t">
          ...
          <div className="flex gap-3">
            ...
            <button
              onClick={onSave}
              className="rounded-xl bg-black text-white px-5 py-2.5 font-medium hover:bg-gray-800 transition disabled:opacity-50 disabled:cursor-not-allowed"
