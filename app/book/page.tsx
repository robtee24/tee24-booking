...
export default async function Page({
  ...
  const serverParams = params ?? null;
  const serverSlug = serverParams?.locationSlug ?? "(no slug)";
...
{JSON.stringify({ serverParams, serverSlug, locErr: locErr?.message ?? null, location }, null, 2)}
        </pre>
      </div>
