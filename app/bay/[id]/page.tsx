 ...
 * Visit: /bay/<anything>
 *
 * This forces Node.js runtime + dynamic rendering and prints the raw props.
 */
  ...
  return (
    <main style={{ padding: 24, fontFamily: "ui-sans-serif, system-ui" }}>
      ...
      <section style={{ display: "grid", gap: 12 }}>
        <div>
          <div style={{ fontWeight: 600 }}>Raw props:</div>
          <pre
            style={{
              marginTop: 8,
              padding: 12,
...
{JSON.stringify(props, null, 2)}
        ...
        <div>
          ...
          >
{JSON.stringify({
  id: typeof props.params?.id === "string" ? props.params.id : "(not a string)",
  paramsType: props.params ? Object.fromEntries(Object.entries(props.params).map(([k, v]) => [k, typeof v])) : "(no params)",
  searchParams: props.searchParams ?? "(none)",
}, null, 2)}
          </pre>
        </div>
