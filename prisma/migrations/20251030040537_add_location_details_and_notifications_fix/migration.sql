...
CREATE TYPE "NotificationKind" AS ENUM ('CONFIRMATION', 'NOTIFICATION');
CREATE TYPE "NotificationChannel" AS ENUM ('EMAIL', 'TEXT');
...
CREATE TABLE "new_Location" (
  ...
  "hours" TEXT NOT NULL DEFAULT '[]', -- JSON stored as TEXT
