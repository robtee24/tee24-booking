...
INSERT INTO "new_Location" ("activeBookingIdentifyBy", "activeBookingWindowHours", "bookingNote", "createdAt", "emailTemplate", "hours", "id", "maxActiveBookingsPerGuest", "maxBookingMinutes", "maxConsecutiveBookingsPerGuest", "minBookingMinutes", "name", "open24Hours", "slug", "smsTemplate", "updatedAt") SELECT "activeBookingIdentifyBy", "activeBookingWindowHours", "bookingNote", "createdAt", "emailTemplate", "hours", "id", "maxActiveBookingsPerGuest", "maxBookingMinutes", "maxConsecutiveBookingsPerGuest", "minBookingMinutes", "name", "open24Hours", "slug", "smsTemplate", "updatedAt" FROM "Location";
DROP TABLE "Location";
